...
import {  Eye, MapPin, QrCode, Trash2, Trash2Icon, Users, X } from 'lucide-react';
...
const EventCard = ({
                    ...
                    <div className='flex-1 min-w-0'>
                        ...
                        <div className='flex items-center gap-1 text-xs text-muted-foreground mb-1'>
                            <MapPin className="w-3 h-3"/>
                                <span>{event.locationType === "Online "? "Online Event": event.city}</span>
                        </div>
  ...
  return (
     <Card className={`overflow-hidden group pt-0 ${onClick ? "cursor-pointer hover:shadow-lg transition-all hover:border-purple-500/50" : ""}`} onClick={onClick}>
        <div className='relative h-48 overflow-hidden'>
                        {event.coverImage ? (
                            ...
                            <div className='absolute op-3 right-3'>
